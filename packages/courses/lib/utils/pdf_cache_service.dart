...
final pdfCacheServiceProvider = Provider((ref) {
  ...
  return PdfCacheService(fileDownloader, sentryService);
});
...
class PdfCacheRequest {
  ...
  bool operator ==(Object other) {
    return other is PdfCacheRequest && other.lessonId == lessonId;
  }
...
class PdfCacheService {
  PdfCacheService(this._fileDownloader, this._sentryService);
