...
void main() {
  group('TimeFormatter.parseDuration', () {
    test('should parse mm:ss format correctly', () {
      expect(TimeFormatter.parseDuration('01:23'), const Duration(minutes: 1, seconds: 23));
    });

    test('should parse hh:mm:ss format correctly', () {
      expect(TimeFormatter.parseDuration('01:23:45'), const Duration(hours: 1, minutes: 23, seconds: 45));
    });
    ...
    test('should parse sub-second decimal format correctly (Case 1: 00:00:01.500)', () {
      expect(
    ...
    test('should parse sub-second decimal format correctly (Case 2: 01:23.45)', () {
      expect(
