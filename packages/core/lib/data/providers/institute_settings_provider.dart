...
final instituteSettingsRemoteDataSourceProvider =
    Provider<InstituteSettingsRemoteDataSource>((ref) {
      return InstituteSettingsRemoteDataSource(dio: ref.watch(dioProvider));
    });

final instituteSettingsLocalDataSourceProvider =
    Provider<InstituteSettingsLocalDataSource>((ref) {
      return InstituteSettingsLocalDataSource();
    });

final instituteSettingsRepositoryProvider =
    Provider<InstituteSettingsRepository>((ref) {
