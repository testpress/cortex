...
final mockSubjectAnalytics = [
  const SubjectAnalyticsDto(
    ...
    incorrectAnswerCount: 12,
    unansweredCount: 994,
    totalQuestionCount: 1010,
  ...
  const SubjectAnalyticsDto(
    ...
    incorrectAnswerCount: 35,
    unansweredCount: 421,
    totalQuestionCount: 469,
  ...
  const SubjectAnalyticsDto(
    id: 3,
    name: 'Chemistry',
    correctAnswerCount: 124,
    incorrectAnswerCount: 154,
    unansweredCount: 1699,
    totalQuestionCount: 1977,
  ...
  const SubjectAnalyticsDto(
    ...
    correctAnswerCount: 58,
    incorrectAnswerCount: 105,
    unansweredCount: 1113,
    totalQuestionCount: 1276,
  ...
  const SubjectAnalyticsDto(
    ...
    incorrectAnswerCount: 39,
    unansweredCount: 271,
    totalQuestionCount: 325,
  ...
  const SubjectAnalyticsDto(
    id: 10,
    name: 'Class 6 Physics',
    correctAnswerCount: 213,
    incorrectAnswerCount: 107,
    unansweredCount: 680,
