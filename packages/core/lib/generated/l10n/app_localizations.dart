...
abstract class AppLocalizations {
  ...
  /// No description provided for @loginSignupUsernameLabel.
  ///
  /// In en, this message translates to:
  /// **'Username'**
  String get loginSignupUsernameLabel;

  /// No description provided for @loginSignupUsernameHint.
  ///
  /// In en, this message translates to:
  /// **'Enter your username'**
  String get loginSignupUsernameHint;
  ...
  /// No description provided for @errorSetupConnectionTitle.
  ///
  /// In en, this message translates to:
  /// **'No internet'**
  String get errorSetupConnectionTitle;
...
class _AppLocalizationsDelegate
  ...
  bool isSupported(Locale locale) =>
      <String>['ar', 'en', 'ml', 'ta'].contains(locale.languageCode);
