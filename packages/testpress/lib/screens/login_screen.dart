...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Widget _buildPasswordForm(AppLocalizations l10n) {
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(height: design.spacing.lg),
        AppButton.primary(
          label: _isBusy ? l10n.loginSigningIn : l10n.loginButton,
          fullWidth: true,
  ...
  Widget _buildOtpForm(AppLocalizations l10n) {
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(height: design.spacing.md),
        AppButton.secondary(
          label: _isBusy ? l10n.loginSendingOtp : l10n.loginGenerateOtp,
          fullWidth: true,
        ...
        SizedBox(height: design.spacing.lg),
        AppButton.primary(
          label: _isBusy ? l10n.loginVerifyingOtp : l10n.loginVerifyOtp,
          fullWidth: true,
  ...
  Future<void> _runAuthAction(Future<void> Function() action) async {
    ...
    try {
      ...
      if (!mounted) return;
      setState(() {
        _errorMessage = _mapAuthMessage(error);
      });
    } catch (_) {
      if (!mounted) return;
        setState(() {
  ...
  String _mapAuthMessage(AuthException error) {
    ...
    return switch (error.type) {
      AuthErrorType.invalidCredentials => l10n.loginErrorInvalidCredentials,
      AuthErrorType.validation => l10n.loginErrorValidation,
      AuthErrorType.throttled => l10n.loginErrorThrottled,
      AuthErrorType.lockout => l10n.loginErrorLockout,
      AuthErrorType.network => l10n.loginErrorNetwork,
      AuthErrorType.serverError => l10n.loginErrorServer,
    };
  }
}
