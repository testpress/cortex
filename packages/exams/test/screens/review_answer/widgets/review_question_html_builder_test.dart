...
void main() {
  ...
  testWidgets('build returns explanationHtml from quizReview when provided', (
    WidgetTester tester,
  ) async {
    ...
    final attemptState = AnswerDto(questionId: 'q1', selectedOptions: []);
  ...
  testWidgets('build uses result from quizReview for exact match evaluation', (
    WidgetTester tester,
  ) async {
    final design = DesignConfig.light();
    final question = const QuestionDto(
  ...
  testWidgets(
    'build prefers exact selected-answer match over false quiz result when correct answers are present',
    (WidgetTester tester) async {
      ...
      final attemptState = AnswerDto(questionId: 'q1', selectedOptions: ['2']);
  ...
  testWidgets('build uses correctAnswers from quizReview when result is null', (
    WidgetTester tester,
  ) async {
    final design = DesignConfig.light();
    final question = const QuestionDto(
  ...
  testWidgets(
    'build falls back to exact match evaluation if quizReview not provided',
    (WidgetTester tester) async {
      final design = DesignConfig.light();
      final question = const QuestionDto(
        id: 'q1',
