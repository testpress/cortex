# Capability: LMS Review Analytics

## Purpose
The LMS Review Analytics capability defines the post-test analytics experience, allowing users to view total scores, correct/incorrect metrics, section breakdowns, and navigations to detailed solution reviews.
## Requirements
