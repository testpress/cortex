# Capability: Info Page

## Purpose
The Info Page provides a client-gated landing experience for curated learning resources, allowing users to browse specialized content and launch external educational videos.
