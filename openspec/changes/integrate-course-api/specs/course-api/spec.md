...
### Dev Login
The system SHALL support simplified dev credentials for testing.

#### Scenario: Dev login
- **WHEN** the user enters "222" as both username and password
- **THEN** the system transitions to authenticated state using the mock user profile "Arjun Sharma"
