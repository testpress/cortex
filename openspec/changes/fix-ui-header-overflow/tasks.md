...
- [x] 1.1 Update `DownloadsHeader` in `packages/courses/lib/widgets/downloads_header.dart` to use a smaller left padding (e.g., `design.spacing.sm` or `8.0`) instead of `design.spacing.screenPadding`
...
- [x] 2.2 Modify the Doubt card layout to move the timeline text to the third row, directly adjacent to the status badge
