...
- **WHEN** the remaining question quota is greater than or equal to the minimum block size (5)
...
- **WHEN** the remaining question quota drops below the minimum block size (5)
...
- **WHEN** the user opens the subject bottom sheet and the remaining quota is lower than the default slider value (15)
