# Capability: Premium Calibration
...
- [ ] **Surface Contrast**: Luminance delta between `canvas` and `card` is between 0.05 and 0.10. (PASS/FAIL)
- [ ] **Shadow Bounds**: `BoxShadow` opacity is within `[0.03, 0.045]`. (PASS/FAIL)
- [ ] **Radius Alignment**: `AppCard` corner radius is exactly 16.0. (PASS/FAIL)
- [ ] **Spacing Rhythm**: All layout gaps match the `Allowed Spacing Set`. (PASS/FAIL)
- [ ] **Typography**: `textPrimary` is not `#000000` and has luminance <= 0.15. (PASS/FAIL)
- [ ] **Singular Separation**: No card instance displays both a border and a shadow simultaneously. (PASS/FAIL)
