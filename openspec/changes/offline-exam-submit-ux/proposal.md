...
### New Capabilities
- `offline-exam-submit-ux`: Covers the end-to-end UX flow from offline submission toast → list status indicator (syncing / submitted) → retained SYNCED state in the downloads list.
