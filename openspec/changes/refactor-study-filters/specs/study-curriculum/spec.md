...
### Requirement: Explicit Lesson Filter
**Reason**: Replaced by using the "All" filter for flattening, avoiding redundancy.
**Migration**: Users will tap "All" to view a flat list of all lessons instead of an explicit "Lesson" filter.
