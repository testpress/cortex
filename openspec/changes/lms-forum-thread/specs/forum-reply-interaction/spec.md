...
A persistent input field must be available at the bottom of the screen to allow users to type and send replies.
...
The "Reply" button must be clearly visible and accessible from anywhere in the thread detail view.
