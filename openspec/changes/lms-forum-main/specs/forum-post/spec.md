...
### Requirement: The system SHALL strictly isolate discussion threads to the course context.
...
### Requirement: The system SHALL display social metadata and authorship as per the design reference.
...
### Requirement: The system SHALL indicate thread resolution states as per the design reference.
